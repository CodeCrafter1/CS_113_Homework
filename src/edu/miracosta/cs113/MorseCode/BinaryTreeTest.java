...
public class BinaryTreeTest {
    ...
    /**
     * Data listed in pre-order traversal order to populate a degenerate
     * BinaryTree.
     */
    private static final String DEGENERATE_INPUT = "A \nnull \nB \nC \nnull \nD \nnull \nE \nnull \nnull \nnull";
    /**
     * Data listed in pre-order traversal order to populate a perfect
     * BinaryTree.
     */
    private static final String PERFECT_INPUT = "A \nB \nC \nnull \nnull \nD \nnull \nnull \nE \nF \nnull \nnull "
            + "\nG \nnull \nnull";
    /**
     * Data listed in pre-order traversal order to populate a complete
     * BinaryTree.
     */
    ...
    /**
     * A BinaryTree to contain Node objects of type String to demonstrate tests
     * using the readBinaryTree function.
     */
