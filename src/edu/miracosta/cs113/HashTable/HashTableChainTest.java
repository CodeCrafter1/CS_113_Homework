...
public class HashTableChainTest {
    ...
    /**
     * Helper method using Map's put() to place a given number of unique
    ...
    /**
     * Helper method to place elements with unique key values and duplicate
     * values based on the above method.
     */
    ...
    public void testEqualsTrue() {
        ...
        System.out.println("in equals " + hashTable.equals(other));
